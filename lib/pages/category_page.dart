...
//  List list = ['名酒','宝丰','二锅头'];
        ...
        builder: (context, child, childCategory){
          return Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index){
                return rightInkWell(index, childCategory.childCategoryList[index]);
              },
            ),
          );
        },
  ...
  void _getGoodList(String categorySubId){
    String aa = '{"code":"0","message":"success","data":[{"image":"http://images.baixingliangfan.cn/compressedPic/20190116145309_40.jpg","oriPrice":2.50,"presentPrice":1.80,"goodsName":"哈尔滨冰爽啤酒330ml","goodsId":"3194330cf25f43c3934dbb8c2a964ade"}]}';
...
class _CategoryGoodsListState extends State<CategoryGoodsList> {
  ...
  Widget _ListWidget(List newList,int index){
    return InkWell(
      onTap: (){
        Application.router.navigateTo(context,"/aaaa?id=${newList[index].goodsId}");
      },
      child: Container(
